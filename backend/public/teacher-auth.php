...
if ($method === 'POST' && $path === '/api/teachers/register') {
    ...
    try {
        ...
        json_response(['error' => 'We could not create the teacher account. Please check the details and try again.'], 502);
    }
    json_response(['message' => 'Account created. You can now sign in.'], 201);
}
