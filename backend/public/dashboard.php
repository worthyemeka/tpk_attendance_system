...
$session = $db->prepare('SELECT id, name, UNIX_TIMESTAMP(starts_at)*1000 AS startsAt FROM service_sessions WHERE campus_id=? AND is_open=1 ORDER BY starts_at DESC LIMIT 1');
