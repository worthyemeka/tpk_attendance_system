...
export function Sidebar() { return <aside className="sidebar"><Link className="brand" href="/account/overview"><Image src="/brand/petra-logo.jpg" alt="Petra Church" width={54} height={54} className="petra-logo" priority /><span className="brand-copy"><Image src="/brand/tpk-logo.jpg" alt="TribePetra Kids" width={118} height={27} className="tpk-logo" priority /><small>Wuse Campus</small></span></Link><Group title="Sunday" items={sunday} /><Group title="People" items={people} /><Group title="Manage" items={manage} /><section className="side-group settings-link"><Link href="/account/settings"><FiSettings /><span>Settings</span></Link></section><div className="sidebar-footer"><div className="avatar">KA<i /></div><div><b>Kemi Adeyemi</b><small>TPK Admin</small><em><i />Online</em></div><FiChevronRight /></div><p className="sidebar-tagline">CHECK IN <b>•</b> BELONG <b>•</b> GROW</p></aside>; }
