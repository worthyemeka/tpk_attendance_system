...
export function AdminTopbar() {
  ...
  return <section className="universal-service-bar">
    ...
    <style jsx global>{`
      ...
      @media(max-width:590px){.universal-meta{width:100%;justify-content:space-between}.universal-meta time{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.universal-meta .notification-button{margin-left:auto;flex:none}}
    `}</style>
  </section>;
}
