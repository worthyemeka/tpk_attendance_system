...
export function AdminTopbar() {
  ...
  return <section className="universal-service-bar">
    ...
    <div className="universal-actions">
      ...
      <Link className="universal-assist" href={isPickupPage ? "/account/pick-up#assisted" : "/account/check-in/assisted"}><span className="assist-full">{isPickupPage ? "Start Assisted Pick-Up" : "Assisted Check-In"}</span><span className="assist-compact">Assisted</span></Link>
    </div>
    ...
    <style jsx global>{`
      ...
      @media(max-width:590px){.universal-meta{justify-content:flex-start}}
    `}</style>
  </section>;
}
