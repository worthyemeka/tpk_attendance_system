...
export default function AccountCheckInPage() {
  ...
  return <section className="staff-checkin">
    ...
    {!canOperate && serviceSessionId && <p className="readonly-notice">Read-only today — desk check-in is available only to the Head of Service and assistants. You can still monitor the live arrivals below.</p>}
