...
export default function AssistedCheckInPage() {
  ...
  const ready = Boolean(
    serviceId && guardian.firstName.trim() && guardian.lastName.trim() && phoneIsValid(guardian.phone) && guardian.relationship && guardian.address.trim() &&
